<p align="center">
<a href="https://github.com/galaxyluvscake/Yang-Kai">
...
<p align="center">
  <a href="https://github.com/galaxyluvscake/Yang-Kai/fork">
    <img src="https://img.shields.io/github/forks/FantoX001/Atlas-MD?label=Fork&style=social">
    
    
  <a href="https://github.com/galaxyluvscake/Yang-Kai/stargazers">
    <img src="https://img.shields.io/github/stars/FantoX001/Atlas-MD?style=social">
  </a>
<p align="center">
<a href="https://github.com/galaxyluvscake/Yang-Kai"><img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=https%3A%2F%2Fgithub.com%2FFantoX001%2FAtlas-MD&count_bg=%23FFA305&title_bg=%23555555&icon=&icon_color=%23E7E7E7&title=People+Visited&edge_flat=false)](https://hits.seeyoufarm.com" width="150px" /></a>
</p>
...
<a href="https://github.com/FantoX001"><img title="Owner" src="https://img.shields.io/badge/Owner-Team Atlas-white.svg?style=for-the-badge&logo=github" width="170px"></a>
 ...
 <a href="https://github.com/galaxyluvscake/Yang-Kai/blob/main/LICENSE.md">
...
<p align="center" >
    <a href="https://heroku.com/deploy?template=https://github.com/galaxyluvscake/Yang-Kai">
...
- [Fork Main Repo](https://github.com/galaxyluvscake/Yang-Kai/fork)
...
- [Download Updated code](https://github.com/galaxyluvscake/Yang-Kai/archive/refs/heads/main.zip) from Main GitHub Repo or Download from your Forked Repo.
...
git clone https://github.com/galaxyluvscake/Yang-Kai
...
``` 
- Note in `git clone <my bot's repo>` section your can use Your customised bot's github link too (For that make sure you [Forked](https://github.com/galaxyluvscake/Yang-Kai/fork) this repo and modified `.env` file and `config.js`).
...
- Read [PublicKeys.md](https://github.com/galaxyluvscake/Yang-Kai/blob/main/PublicKeys.md) to use our `provided public keys` if you are lazy to create your own. We have already provided everying you need to run the bot.
...
- Atlas comes with [MIT](https://github.com/galaxyluvscake/Yang-Kai/blob/main/LICENSE.md) License which means you can use it as a `base for your own bot` and can `modify it as you want` and can `add your own features`.
...
- Check [Atlas Contributors](https://github.com/galaxyluvscake/Yang-Kai/graphs/contributors) list.
